...
//    defaultParameters.addArgument(PARAMETER_KAFKA_KEY, "${PARAMETER_KAFKA_KEY}");
    defaultParameters.addArgument(PARAMETER_KAFKA_KEY, null);
...
//    defaultParameters.addArgument(PARAMETER_KAFKA_SSL_KEYSTORE, null);
//    defaultParameters.addArgument(PARAMETER_KAFKA_SSL_KEYSTORE_PASSWORD, null);
//    defaultParameters.addArgument(PARAMETER_KAFKA_SSL_TRUSTSTORE, null);
//    defaultParameters.addArgument(PARAMETER_KAFKA_SSL_TRUSTSTORE_PASSWORD, null);
//    defaultParameters.addArgument(PARAMETER_KAFKA_USE_SSL, null);
